...
const en: Dict = {
  ...
  pages: {
    ...
    integrations: {
      ...
      blendBody: "Lending markets on Stellar for extra yield on idle dollars.",
      pixName: "PIX · Brazil",
      ...
      note: "DeFindex yield is live on-chain — a real vault on Stellar testnet with verifiable deposits. Blend and the local payout rails are illustrative for now (Blend testnet pools · SEP-24/31 anchors). Treasury settlement is fully on-chain.",
    },
    security: {
      eyebrow: "Security",
...
const es: Dict = {
  ...
  pages: {
    ...
    integrations: {
      ...
      blendBody: "Mercados de préstamo en Stellar para rendimiento extra sobre dólares ociosos.",
      pixName: "PIX · Brasil",
      ...
      note: "El rendimiento de DeFindex está en vivo on-chain — un vault real en la testnet de Stellar con depósitos verificables. Blend y los rieles de pago locales son ilustrativos por ahora (pools de Blend en testnet · anchors SEP-24/31). La liquidación de tesorería es 100% on-chain.",
    },
    security: {
      eyebrow: "Seguridad",
...
const pt: Dict = {
  ...
  pages: {
    ...
    integrations: {
      ...
      blendBody: "Mercados de empréstimo na Stellar para rendimento extra sobre dólares parados.",
      pixName: "PIX · Brasil",
      ...
      note: "O rendimento da DeFindex está ao vivo on-chain — um vault real na testnet da Stellar com depósitos verificáveis. Blend e os trilhos de pagamento locais são ilustrativos por enquanto (pools da Blend em testnet · anchors SEP-24/31). A liquidação da tesouraria é 100% on-chain.",
    },
    security: {
      eyebrow: "Segurança",
