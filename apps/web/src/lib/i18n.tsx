...
const en: Dict = {
  ...
  pages: {
    ...
    integrations: {
      ...
      statusReady: "Ready",
      defindexName: "DeFindex vaults",
      defindexBody: "Automated yield strategies on Stellar. Spare cash earns here when it's above your safety cushion.",
      ...
      note: "Yield integrations run in demo mode for the hackathon; payout rails are wired conceptually via SEP-24/31 anchors. On-chain treasury settlement is fully live.",
    },
    security: {
      eyebrow: "Security",
...
const es: Dict = {
  ...
  pages: {
    ...
    integrations: {
      ...
      statusReady: "Listo",
      defindexName: "Bóvedas DeFindex",
      defindexBody: "Estrategias de rendimiento automatizadas en Stellar. El excedente rinde aquí cuando supera tu colchón de seguridad.",
      ...
      note: "Las integraciones de rendimiento corren en modo demo para el hackathon; los rieles de pago están cableados conceptualmente vía anchors SEP-24/31. La liquidación on-chain de tesorería está 100% en vivo.",
    },
    security: {
      eyebrow: "Seguridad",
...
const pt: Dict = {
  ...
  pages: {
    ...
    integrations: {
      ...
      statusMock: "Em breve",
      statusReady: "Pronto",
      defindexName: "Cofres DeFindex",
      defindexBody: "Estratégias de rendimento automatizadas na Stellar. A sobra rende aqui quando passa do seu colchão de segurança.",
      ...
      note: "As integrações de rendimento rodam em modo demo para o hackathon; os trilhos de pagamento estão conectados conceitualmente via anchors SEP-24/31. A liquidação on-chain da tesouraria está 100% ao vivo.",
    },
    security: {
      eyebrow: "Segurança",
